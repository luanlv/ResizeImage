...
//main
!function(t,i){i.email="luanlv2591@gmail.com",i.checkoutTo=PayPal,i.currency="VND",i.cartHeaders=["Name","Price","Quantity","Total","remove"],i.sandbox=!1,i.paypalHTTPMethod="GET",CartItem.prototype.sku=function(){var t='1 1/2" Large Black Cap'==this.name?"102":'1 1/4" Large Black Cap'==this.name?"101":'2 1/4" Large Black Cap'==this.name?"103":"104";return"None"==this.options?t+"-0":t+"-1"},CartItem.prototype.gaVariation=function(){return this.size};var a=function(){$(".cartBar").animate({marginTop:0},100),$("#container").animate({marginTop:24},100)};$(function(){var t=$("#running-total"),a=$("#item-quantity"),e=$(".item_price"),n=function(){var n={quantity:a.val(),price:e.val()};t.html(i.valueToCurrencyString(n.quantity*n.price))},o=window.reset=function(){a.val(1),n()};$("#view_cart").click(function(){$(this).hasClass("open")?($(this).text("Chi tiết"),$("#cart").slideUp()):($(this).html("Ẩn đi"),$("#cart").slideDown()),$(this).toggleClass("open")}),$(".simpleCart_empty").click(function(){$(".cartBar").animate({marginTop:-24},200),$("#container").animate({marginTop:0},200);var t=$("#view_cart");t.hasClass("open")&&(t.hasClass("open")?(t.text("Chi tiết"),$("#cart").slideUp()):($(this).text("Ẩn đi"),$("#cart").slideDown()),t.toggleClass("open"),$("#cart").attr("style",""))}),$(".item_quantity").change(function(){n()}),o()}),i.ready(function(){i.bind("afterAdd",function(){i.quantity&&a()}),i.bind("afterRemove",function(){i.quantity||$(".simpleCart_empty").trigger("click")}),i.quantity&&a(),$(".item_add").prop("disabled",!1)}),$(document).on("click",".item_add",function(){var t=$(".simpleCart_total"),i=$(this).parent(".simpleCart_shelfItem").find("img").eq(0);if(i){var a=i.clone().offset({top:i.offset().top,left:i.offset().left}).css({opacity:"0.5",position:"absolute",height:"150px",width:"150px","z-index":"1002"}).appendTo($("body")).animate({top:t.offset().top+10,left:t.offset().left+10,width:75,height:75},400,"easeInOutExpo");a.animate({width:0,height:0},function(){$(this).detach()})}}),$(".laside > ul > span").on("click",function(){$(this).siblings("li").toggleClass("hide")})}(jQuery,simpleCart);
