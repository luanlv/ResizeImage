...
$(function(){$(document).pjax("a","#pjax-container"),$(document).on("submit","form[data-pjax]",function(n){$.pjax.submit(n,"#pjax-container")}),$(document).on("pjax:error",function(n,t,o,s,a){t.status>=400&&t.status<500&&a.success(t.responseText,status,t)}),$(document).on("pjax:start",function(){NProgress.start()}),$(document).on("pjax:end",function(){NProgress.done()})});
